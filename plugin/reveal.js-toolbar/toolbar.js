 ...
 *		- tooltips
 */
//import { openSpeakerWindow } from 'assets/reveal-js/plugin/notes/notes.js'
      ...
      if (initialise) {
        ...
        if (captureMenu) {
          ...
          var id_menu = setInterval(function() {
            //https://github.com/denehyg/reveal.js-toolbar/issues/14#issuecomment-1219963857
